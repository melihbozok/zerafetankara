<head>
    ...
    <title>Zerafet Ankara | Kurumsal</title>
...
<style>
    ...
    @media (max-width: 767px) {
       ...
       nav {
        ...
        <section class="headerAlt">
            <div class="row">
                <div class="header-top animated rotateIn">
                    <a href="index.php"><img src="assets/document/logo2.png" class="img-fluid"/></a>
                </div>
                <div class="header-bottom">
                    <div class="col-md-12 col-sm-6">
                        <div class="menu menuAlt animated">
                            <ul>
                                <li><a href="index.php"><i class="fa fa-home"></i></a></li>
                                <li><a href="kurumsal.php" class="selectedMenu">Kurumsal</a></li>
                                <li><a href="hizmetler.php">HİZMETLER<span class="sr-only">(current)</span></a></li>
                                <li><a href="menu.php">Menüler</a></li>
                                ...
                                <li class="noAfter">
                                    ...
                                    <div class="search-group searchAlt" style="display: none">
